...
- Avoir des code smells
- Avoir des fichiers qui ont remplissent plusieurs fonctions non corrélées
- Avoir des fonctions qui font plus de 20 lignes
- Code pas documenté
- Code verbeux (généré par IA)
...
- Fonction courtes (max 20 lignes)
- Projet répartis en plusieurs fichiers (et pas 2000 lignes dans un seul fichier)
